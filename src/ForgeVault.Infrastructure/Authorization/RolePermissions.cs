...
//
// | Role            | ProjectWrite | EnvironmentWrite | SecretWrite | SecretReadValue | AuditRead | RoleAssignmentWrite |
// |-----------------|:---:|:---:|:---:|:---:|:---:|:---:|
// | Owner           |  x  |  x  |  x  |  x  |  x  |  x  |
// | Admin           |  x  |  x  |  x  |  x  |  x  |  x  |
// | SecurityAdmin   |     |     |  x  |  x  |  x  |     |
...
internal static class RolePermissions
{
    ...
    {
        [Role.Owner] = [Permission.ProjectWrite, Permission.EnvironmentWrite, Permission.SecretWrite, Permission.SecretReadValue, Permission.AuditRead, Permission.RoleAssignmentWrite],
        [Role.Admin] = [Permission.ProjectWrite, Permission.EnvironmentWrite, Permission.SecretWrite, Permission.SecretReadValue, Permission.AuditRead, Permission.RoleAssignmentWrite],
